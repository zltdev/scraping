...
window.UPDATES = [
  {
    ...
    resumen_por_fuente: {
      ...
      "argenprop — Cutral Có":                     { snapshot: 1,  hoy: 1,  agregadas: 0, bajadas: 0, nota: "19833452 (1983x) PERSISTE 10.º chequeo consecutivo — récord propio renovado por cuarto día consecutivo. Ahora pasa a 4.º techo del run tras la entrada de 1988x en Rincón (era 3.er techo)." },
      "argenprop — Neuquén capital":               { snapshot: 20, hoy: 20, agregadas: 0, bajadas: 0 },
      "argenprop — Plaza Huincul":                 { snapshot: 5,  hoy: 5,  agregadas: 0, bajadas: 0, nota: "19798515 (1979x) frontier local sin cambios — la ronda multi-fuente del run sigue saltando Plaza Huincul: Cutral Có → Campana → Plottier → Rincón. Plaza Huincul nunca activada como sede del frontier global." },
      "argenprop — Plottier":                      { snapshot: 20, hoy: 20, agregadas: 0, bajadas: 0, nota: "ESPEJO ABSOLUTO 2.º día consecutivo. **Doblete 1987x (19870568+19871079) PERSISTE 3.º chequeo pero PIERDE título de frontier global** tras solo 2 chequeos (Rincón toma el relevo con 1988x). 2.º techo del run, cuarto ex-frontier consolidado del run (junto a 19833452, 19862176, y ahora el propio doblete). 8214482 PERSISTE 12.º chequeo (récord propio renovado) — último caso límite vivo de hiper-estabilidad histórica. 19755626 NO vuelve (12.º chequeo afuera, récord propio renovado). 12060433 (1206x, salido 18-06) 3.er chequeo afuera. 19450773 (1945x, salido 18-06) 3.er chequeo afuera." },
      "argenprop — Rincón de los Sauces":          { snapshot: 6,  hoy: 7,  agregadas: 1, bajadas: 0, nota: "**ÚNICA FUENTE CON MOVIMIENTO HOY**. ROMPE su axiomática HIPER-absoluta de 9 chequeos idénticos — primera fluctuación significativa post-9 chequeos, y la fluctuación es de MAGNITUD MÁXIMA (récord absoluto del run, no regresión). ENTRA 19887818 (1988x, slug genérico /rincon-de-los-sauces) — **NUEVO FRONTIER GLOBAL DEL RUN** que rompe el doblete 1987x de Plottier. Primera vez del run que Rincón hospeda el frontier global. 3.ª migración del frontier global en 4 días (Cutral Có → Campana → Plottier → Rincón). Set Rincón pasa de 6 → 7 IDs SIN baja compensatoria — única expansión sin baja del run. Los 6 IDs previos (15827220, 16238703, 18504073, 19019897, 19047316, 9068551) PERSISTEN intactos." },
      "argenprop — Campana":                       { snapshot: 20, hoy: 20, agregadas: 0, bajadas: 0, nota: "ESPEJO ABSOLUTO 3.er día consecutivo. **19862176 (1986x, monet-barrio-privado) PERSISTE 4.º chequeo** — consolidación definitiva de ex-frontier sin precedente del run. Ahora 3.er techo del run (era 2.º). Cluster Cardales global se mantiene en 8 IDs; cluster countries-y-barrios-cerrados-en-campana 2 IDs (15608517, 18619706). Cluster Campana barrios privados: 9 IDs (8 Cardales + 1 Monet). 18526091 mantiene slug `cardales-village` 4.º chequeo. 19812510 (salido 15-06) 5.º chequeo afuera — VENTANA 5-7 DÍAS CIERRA (salida definitiva consolidada). 16475158 (salido 17-06) 4.º chequeo afuera." },
      ...
      "vacamuertapropiedades — home (terrenos)":   { snapshot: 4,  hoy: 4,  agregadas: 0, bajadas: 0, nota: "**VUELVE AL CANÓNICO `vacamuertapropiedades.com.ar`** tras 2 chequeos en `vaca-muerta-propiedades.com` (con guiones). REFUTACIÓN INDISCUTIBLE de la hipótesis 'cambio definitivo de dominio' — la variante con guiones fue TRANSITORIA exactamente 2 días (18-06 y 19-06). Los 4 terrenos (pid9, pid67, pid127, pid263) PERSISTEN idénticos — **9.º chequeo consecutivo idéntico** desde el 12-06." }
    },
    cambios: [
      { fuente: "argenprop — Rincón de los Sauces", tipo: "agregada", url: "https://www.argenprop.com/terreno-en-venta-en-rincon-de-los-sauces--19887818", nota: "**ID NUEVO 1988x, slug genérico /rincon-de-los-sauces — NUEVO FRONTIER GLOBAL DEL RUN**. Rompe el doblete 1987x de Plottier (19870568+19871079) que persistió solo 2 chequeos como frontier global. Primera vez del run que Rincón hospeda el frontier global. 3.ª migración del frontier global en 4 días (Cutral Có 11-06 → Campana 17-06 → Plottier 18-06 → Rincón 20-06). Set Rincón pasa de 6 → 7 IDs SIN baja compensatoria — ÚNICA expansión sin baja del run en una fuente con cardinalidad históricamente estable. Salto generacional +1 sobre el doblete previo. Cumple INDISCUTIBLEMENTE la sub-hipótesis 19-06 'si Rincón modifica set tras 9 chequeos = primera fluctuación realmente significativa' — pero con MAGNITUD MÁXIMA (récord absoluto del run, no regresión). Patrón nuevo confirmado: cuando una fuente HIPER-estable rompe su espejo, lo hace con avance generacional, no con baja." }
    ],
    nota: "Cadencia diaria preservada. **EVENTO MAYOR DEL RUN: NUEVO FRONTIER GLOBAL 1988x en Rincón de los Sauces** (19887818, slug genérico). Rompe el doblete 1987x de Plottier (que sigue vivo pero pierde título tras solo 2 chequeos como frontier). **3.ª migración del frontier global en 4 días**: Cutral Có 11-06 (1983x, 6 días) → Campana 17-06 (1986x, 1 día) → Plottier 18-06 (1987x doblete, 2 días) → Rincón 20-06 (1988x, day 1). **Rincón ROMPE su axiomática HIPER-absoluta de 9 chequeos idénticos** — primera fluctuación significativa post-9 chequeos, y la fluctuación es de magnitud MÁXIMA. Set Rincón 6 → 7 IDs SIN baja compensatoria. **vacamuertapropiedades VUELVE AL CANÓNICO `.com.ar`** tras 2 chequeos en variante con guiones — REFUTACIÓN INDISCUTIBLE de la hipótesis 'cambio definitivo de dominio'; variante transitoria exacta de 2 días. **Pausa del corredor interrumpida día 2** post-doblete con magnitud máxima — el run mantiene cadencia agresiva. **Verificación de hipótesis del 19-06**: (1) 19870568/19871079 persisten 3.º día → PARCIAL, persisten pero pierden título de frontier global; (2) reaparece 19812510 → NO (ventana cierra, 5.º chequeo afuera); (3) reaparecen 16475158/12060433/19450773 → NO (4.º, 3.º, 3.º chequeo afuera); (4) 19862176 persiste 4.º chequeo → SE CUMPLE — consolidación definitiva ex-frontier sin precedente; (5) entra OTRO ID 1987x+ o NUEVO doblete → PARCIAL, entra 19887818 (1988x) pero no es doblete; (6) pausa del corredor llega a 2 días → NO, pausa de 1 solo día; (7) Plaza Huincul/Chañar a 1980x+ → NO; (8) Rincón modifica set tras 9 chequeos → SE CUMPLE CON MAGNITUD MÁXIMA — récord absoluto del run; (9) Cutral Có 19833452 rota → NO (10.º chequeo, récord propio renovado); (10) vacamuertapropiedades vuelve al canónico → SE CUMPLE INDISCUTIBLEMENTE — variante con guiones TRANSITORIA exacta de 2 días; (11) 8214482 cae → NO (12.º chequeo, récord propio renovado). **PATRONES NUEVOS CONFIRMADOS**: (a) ROTACIÓN DE FRONTIER ACELERADA — 4 fuentes distintas en 9 días, cadencia se reduce de 6 días a 1-2 días; (b) FUENTE HIPER-ESTABLE ROMPE ESPEJO CON AVANCE GENERACIONAL, NO CON BAJA — Rincón confirma patrón nuevo; (c) CUATRO TECHOS DEL RUN VIVOS SIMULTÁNEAMENTE por primera vez (1988x > 1987x doblete > 1986x > 1983x) — los ex-frontiers no caen, se acumulan como capas sedimentarias; (d) VARIANTE DOMINIO CON GUIONES ES TRANSITORIA exacta de 2 días. **HIPER-CONSOLIDACIONES**: Cutral Có 19833452 10.º chequeo (récord propio renovado), Plottier 8214482 12.º chequeo (récord propio renovado), Plottier 19755626 12.º afuera (récord propio renovado), Campana 19862176 4.º chequeo (consolidación ex-frontier sin precedente). Cluster Cardales sin cambios (8 IDs). vacamuertapropiedades: 4 terrenos idénticos 9.º chequeo desde el 12-06, vuelve a canónico. No se regenera listings.js (la alta es Rincón, fuera del scope inmediato del catálogo Vaca Muerta sin info de superficie/precio). Sugerencias para 21-06: (1) si 19887818 persiste = consolidación frontier 1988x; si cae 1-2 días = frontier volátil; (2) si entra OTRO ID 1988x+ o frontier ≥1989x = ronda multi-fuente activada en Rincón o migración instantánea; (3) si reaparecen 16475158/12060433/19450773 = oscilación múltiple confirmada; (4) si 19862176 cae sin recuperar título = fin del ciclo Monet tras 4 chequeos; (5) si doblete 1987x cae tras pérdida del título = 'doblete sin frontier es volátil'; (6) si entra OTRO doblete = régimen de lotes atómicos confirmado al fin; (7) si Plaza Huincul/Chañar a 1980x+ = ronda multi-fuente carril original; (8) si Rincón vuelve a 6 IDs = expansión transitoria; si persiste 7 IDs = nueva cardinalidad consolidada; (9) si Cutral Có 19833452 rota tras 10 chequeos = primera baja del 1983x histórico; (10) si vacamuertapropiedades vuelve a guiones tras 1 día canónico = oscilación frecuente del dominio; si persiste canónico 3.º chequeo = recuperación completa; (11) si 8214482 cae = fin del último caso límite hiper-estabilidad histórica; (12) si entra frontier global en Centenario/Añelo/Neuquén/Zárate = rotación completa la cobertura de todas las fuentes ≥5 IDs."
  },
  {
    fecha: "2026-06-19",
    snapshot_base: "2026-06-18",
    resumen_por_fuente: {
      "argenprop — Añelo":                         { snapshot: 20, hoy: 20, agregadas: 0, bajadas: 0 },
      "argenprop — Centenario":                    { snapshot: 20, hoy: 20, agregadas: 0, bajadas: 0 },
      "argenprop — San Patricio del Chañar":       { snapshot: 20, hoy: 20, agregadas: 0, bajadas: 0 },
      "argenprop — Cutral Có":                     { snapshot: 1,  hoy: 1,  agregadas: 0, bajadas: 0, nota: "19833452 (1983x) PERSISTE 9.º chequeo consecutivo — récord propio renovado por tercer día consecutivo. Tercer techo del run, axiomática absoluta." },
      "argenprop — Neuquén capital":               { snapshot: 20, hoy: 20, agregadas: 0, bajadas: 0 },
      "argenprop — Plaza Huincul":                 { snapshot: 5,  hoy: 5,  agregadas: 0, bajadas: 0, nota: "19798515 (1979x) frontier local sin cambios — la pausa del corredor generacional ahora afecta a TODAS las fuentes con frontier local, no solo a Plaza Huincul/Chañar." },
      "argenprop — Plottier":                      { snapshot: 20, hoy: 20, agregadas: 0, bajadas: 0, nota: "VUELVE A ESPEJO ABSOLUTO tras el sacudón 2+/2- del 18-06. **CONSOLIDACIÓN DEL DOBLETE 1987x**: 19870568 + 19871079 (ambos 1987x, slug genérico) PERSISTEN 2.º chequeo — NO son volátiles, doblete CONFIRMADO como nuevo frontier global del run. 8214482 PERSISTE 11.º chequeo (récord propio renovado) — último caso límite vivo de hiper-estabilidad histórica (sobrevive tras la caída de 12060433 ayer). 19755626 NO vuelve (11.º chequeo afuera, récord propio renovado). 12060433 (1206x, salido 18-06) 2.º chequeo afuera. 19450773 (1945x, salido 18-06) 2.º chequeo afuera." },
      "argenprop — Rincón de los Sauces":          { snapshot: 6,  hoy: 6,  agregadas: 0, bajadas: 0, nota: "Set idéntico 9.º chequeo post-salto — récord propio renovado. Axiomática HIPER-absoluta del sistema. 15827220 + 16238703 confirmados permanentes." },
      "argenprop — Campana":                       { snapshot: 20, hoy: 20, agregadas: 0, bajadas: 0, nota: "ESPEJO ABSOLUTO 2.º día consecutivo. 19862176 (1986x, monet-barrio-privado) PERSISTE 3.º chequeo — sigue vivo como segundo techo del run SIN recuperar título de frontier global (consolidación de ex-frontier sin precedente). Cluster Cardales global se mantiene en 8 IDs; cluster countries-y-barrios-cerrados-en-campana 2 IDs (15608517, 18619706). Cluster Campana barrios privados: 9 IDs (8 Cardales + 1 Monet). 18526091 mantiene slug `cardales-village` 3.º chequeo (slug rotation estable). 19812510 (salido 15-06) 4.º chequeo afuera — ventana 5-7 días casi cierra (queda 1-3 días). 16475158 (salido 17-06) 3.er chequeo afuera." },
      "argenprop — Zárate":                        { snapshot: 20, hoy: 20, agregadas: 0, bajadas: 0 },
      "icasas — Añelo":                            { snapshot: null, hoy: null, agregadas: null, bajadas: null, nota: "Omitido: la paginación rota orden entre cargas y el diff no es confiable." },
      "vacamuertapropiedades — home (terrenos)":   { snapshot: 4,  hoy: 4,  agregadas: 0, bajadas: 0, nota: "**2.º chequeo consecutivo en `vaca-muerta-propiedades.com`** (con guiones, sin .ar). La variante con guiones se consolida — sin evidencia de retorno al canónico vacamuertapropiedades.com.ar. La hipótesis 'cambio definitivo de dominio' gana fuerza pero requiere 3-5 chequeos más para consolidar. Los 4 terrenos (pid9, pid67, pid127, pid263) PERSISTEN idénticos — **8.º chequeo consecutivo idéntico** desde el 12-06." }
    },
    cambios: [],
    nota: "Cadencia diaria preservada. **ESPEJO ABSOLUTO EN LAS 11 FUENTES 0+/0-** — CUARTO espejo absoluto del run (12-06, 14-06, 16-06, 19-06) y el primero post-DOBLETE 1987x. **CONFIRMACIÓN MASIVA DE HIPÓTESIS 18-06**: el doblete 19870568 + 19871079 PERSISTE 2.º chequeo → DOBLETE NO ES VOLÁTIL, nuevo frontier global del run consolidado en Plottier. Plottier vuelve a espejo absoluto tras el sacudón 2+/2- de ayer. **Verificación de hipótesis del 18-06**: (1) 19870568/19871079 persisten → SE CUMPLE INDISCUTIBLEMENTE, doblete consolidado; (2) reaparece 19812510/16475158/12060433/19450773 → NO, todos afuera (4.º, 3.er, 2.º, 2.º chequeo respectivamente); (3) 19862176 cae sin recuperar título → NO, variante intermedia: PERSISTE 3.º chequeo como segundo techo; (4) OTRO doblete generacional → NO, sin nuevas altas; (5) Plaza Huincul/Chañar a 1980x+ → NO; (6) Rincón modifica set → NO (9.º chequeo, récord propio renovado); (7) Cutral Có rota → NO (9.º chequeo, récord propio renovado); (8) vacamuertapropiedades vuelve a .com.ar → NO, persiste en vaca-muerta-propiedades.com (2.º chequeo, hipótesis 'cambio definitivo' gana fuerza); (9) 8214482 cae → NO (11.º chequeo, récord propio renovado). **PATRONES NUEVOS REFORZADOS**: (a) HIPER-PERSISTENCIA HISTÓRICA EN AISLAMIENTO — 8214482 es el ÚNICO caso límite vivo tras la caída de 12060433 ayer (N=1 para la hipótesis 'clase histórica con slug genérico es estable'); (b) FRONTIER GLOBAL CAMBIA DE PROPIEDAD SIN QUE EL VIEJO TECHO CAIGA — 19862176 PERSISTE 3.º chequeo sin recuperar título, consolidación de ex-frontier sin precedente del run; (c) PAUSA DEL CORREDOR DÍA 1 POST-DOBLETE — primera pausa post-doblete generacional del run, posible correlación entre magnitud del salto y duración de la pausa siguiente. **HIPER-CONSOLIDACIONES**: Cutral Có 19833452 9.º chequeo (récord propio renovado), Plottier 8214482 11.º chequeo (récord propio renovado), Plottier 19755626 11.º afuera (récord propio renovado), Rincón 9.º chequeo idéntico. Cluster Cardales sin cambios (8 IDs). vacamuertapropiedades: 4 terrenos idénticos 8.º chequeo desde el 12-06, ahora en variante con guiones por 2.º día. No se regenera listings.js (cero altas materiales). Sugerencias para 20-06: (1) si 19870568/19871079 persisten 3.º día = HIPER-consolidación frontier 1987x; (2) si reaparece 19812510 = último día de la ventana 5-7 días para 'frontier oscila vuelve'; (3) si reaparecen 16475158/12060433/19450773 = oscilación múltiple; (4) si 19862176 cae sin recuperar título = fin del ciclo Monet; si persiste 4.º chequeo = consolidación definitiva de ex-frontier; (5) si entra OTRO ID 1987x+ o NUEVO doblete = régimen de lotes atómicos confirmado; (6) si pausa del corredor llega a 2 días = primera pausa post-doblete documentada; (7) si Plaza Huincul/Chañar a 1980x+ = ronda multi-fuente carril original; (8) si Rincón modifica set tras 9 chequeos = primera fluctuación significativa; (9) si Cutral Có 19833452 rota = primera baja del 1983x histórico tras 9 chequeos; (10) si vacamuertapropiedades vuelve al canónico = variante guiones transitoria 2-3 días; si persiste 3.º día = consolidación cambio dominio; (11) si 8214482 cae = fin del último caso límite hiper-estabilidad histórica (refutación definitiva)."
  },
  {
    fecha: "2026-06-18",
